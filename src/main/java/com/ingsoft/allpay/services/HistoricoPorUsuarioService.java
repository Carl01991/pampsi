...
public interface HistoricoPorUsuarioService extends JpaRepository<HistorialCobros, Serializable>{
	@Query("select new com.ingsoft.allpay.resultmodel.HistoricoPorCiudadano(hc.idHistoricoCobros as id, DATE(hc.fecha) as fecha, (hc.valor*ht.tarifa) as valorPagar) "
